...
export class SkillsComponent implements OnInit {
  ...
  constructor(private _projectSkillsService: SkillsService, private _messageService: MessageService, public modalService: NgbModal) { }
  ...
  ngOnInit() {
    this.breadCrumbItems = [{ label: 'Skills' }, { label: 'Skills List', active: true }];
  ...
  getRecords() {
    this.showLoader();
    this._projectSkillsService.getAll(
      this.filterText,
      null,
  ...
  deleteProject(data): boolean {
    return this._projectSkillsService.delete(data.id).then(res => {
      if (res.success)
        return true;
      else
        return false;
