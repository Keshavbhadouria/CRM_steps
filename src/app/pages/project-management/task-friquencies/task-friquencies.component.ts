...
@Component({
  selector: 'app-task-friquencies',
  templateUrl: './task-friquencies.component.html',
  styleUrls: ['./task-friquencies.component.scss']
})
export class TaskFriquenciesComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.breadCrumbItems = [{ label: 'Tasks' }, { label: 'TaskFrequencies', active: true }];
