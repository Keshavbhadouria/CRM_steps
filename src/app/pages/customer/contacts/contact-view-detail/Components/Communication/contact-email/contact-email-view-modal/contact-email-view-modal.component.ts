...
@Component({
  selector: 'app-contact-email-view-modal',
  templateUrl: './contact-email-view-modal.component.html',
  styleUrls: ['./contact-email-view-modal.component.scss']
})
export class ContactEmailViewModalComponent implements OnInit {
