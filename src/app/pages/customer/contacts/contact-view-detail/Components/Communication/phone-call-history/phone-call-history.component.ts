...
@Component({
  selector: 'PhoneCallHistory',
  templateUrl: './phone-call-history.component.html',
  styleUrls: ['./phone-call-history.component.scss']
})
export class PhoneCallHistoryComponent implements OnInit {
  ...
  getRecords() {
    this.showLoader();
    this._phoneCallService.getAllByContactId(
      this.filterText,
      this.contactId,
      this.maxDateFilter,
      this.minDateFilter,
