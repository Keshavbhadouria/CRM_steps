...
@Component({
  selector: 'app-contact-payment-history-view-modal',
  templateUrl: './contact-payment-history-view-modal.component.html',
  //styleUrls: ['./contact-payment-history-view-modal.component.scss']
})
export class ContactPaymentHistoryViewModalComponent implements OnInit {
