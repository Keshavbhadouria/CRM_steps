...
@Component({
  selector: 'app-contact-retainer-view-modal',
  templateUrl: './contact-retainer-view-modal.component.html',
  styleUrls: ['./contact-retainer-view-modal.component.scss']
})
export class ContactRetainerViewModalComponent implements OnInit {
