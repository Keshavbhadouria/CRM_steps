...
@Component({
  selector: 'app-service-activity-steps-view-modal',
  templateUrl: './service-activity-steps-view-modal.component.html',
  styleUrls: ['./service-activity-steps-view-modal.component.scss']
})
export class ServiceActivityStepsViewModalComponent implements OnInit {
