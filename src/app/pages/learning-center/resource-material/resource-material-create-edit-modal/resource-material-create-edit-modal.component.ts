...
@Component({
  selector: 'app-resource-material-create-edit-modal',
  templateUrl: './resource-material-create-edit-modal.component.html',
  styleUrls: ['./resource-material-create-edit-modal.component.scss']
})
export class ResourceMaterialCreateEditModalComponent implements OnInit {
