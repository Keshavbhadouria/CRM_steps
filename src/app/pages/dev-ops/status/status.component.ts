...
export class StatusComponent implements OnInit {
  ...
  tableSettings: ColumnSetting[] = [
    ...
    {
      primaryKey: 'clientApplicationStatus.statusName',
      header: 'StatusName',
    }
  ];
  ...
  buttonSettings: ButtonSettings[] = [
    {
      title: 'View',
      func: (obj) => {
        this.viewStatus = obj.clientApplicationStatus;
    ...
    },
    {
      title: 'Edit',
      func: (obj) => {
        this.editStatus = obj.clientApplicationStatus;
    ...
    },
    {
      title: 'Delete',
      func: (obj) => {
        this.onDelete(obj.clientApplicationStatus.id);
      },
  ...
  ngOnInit(): void {
    this.breadCrumbItems = [{ label: 'DevOps' }, { label: 'Status', active: true }];
  ...
  onDelete(id) {
    ...
    swalWithBootstrapButtons
      ...
      .then(result => {
        if (result.value) {
          this.showLoader();
          this._statusServices.delete(id)
            .then(res => {
              this.hideLoader();
              if (res.success) {
                this.getRecords();
