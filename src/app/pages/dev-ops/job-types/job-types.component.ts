...
import { JobTypesService } from 'src/app/core/services/job-types.service';
...
export class JobTypesComponent implements OnInit {
  ...
  buttonSettings: ButtonSettings[] = [
    ...
    },
    {
      ...
      func: (obj) => {
        this.showLoader();
        this._jobTypeService.getJobTypeForEdit(obj.jobType.id).then(s => {
          this.hideLoader();
          this.editJobType = s.result.jobType;
  ...
  constructor(private _messageService: MessageService,
    ...
    private _jobTypeService: JobTypesService,
  ...
  onDelete(id) {
    ...
    swalWithBootstrapButtons
      ...
      .then(result => {
        if (result.value) {
          this.showLoader();
          this._jobTypeService.delete(id)
            .then(res => {
              this.hideLoader();
              if (res.success) {
                this.getRecords();
