...
import { DeploymentDetailsService } from 'src/app/core/services/deployment-details.service';
...
export class DeploymentDetailsComponent implements OnInit {
  ...
  tableSettings: ColumnSetting[] = [
    ...
    {
      primaryKey: 'deploymentManagementDetail.certified',
      header: 'Certified',
    },
  ];
  ...
  buttonSettings: ButtonSettings[] = [
    ...
    },
    {
      title: 'Edit',
      func: (obj) => {
        this.editStatus = obj.deploymentManagementDetail;
    ...
    },
    {
      title: 'Delete',
      func: (obj) => {
        this.onDelete(obj.deploymentManagementDetail.id);
      },
  ...
  constructor(private _messageService: MessageService,
    ...
    private _deployServices: DeploymentDetailsService) {
