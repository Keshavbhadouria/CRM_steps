...
import { TestTypesService } from 'src/app/core/services/test-types.service';
...
export class TestTypeComponent implements OnInit {
  ...
  constructor(private _messageService: MessageService,
    ...
    private _testTypesService: TestTypesService) { }
  ...
  tableSettings: ColumnSetting[] = [
    ...
    {
      primaryKey: 'testType.typeName',
      header: 'TypeName',
    },
    {
      primaryKey: 'testType.description',
      header: 'Description',
    },
  ];
  ...
  buttonSettings: ButtonSettings[] = [
    ...
    },
    {
      title: 'Edit',
      func: (obj) => {
        this.editTestType = obj.testType;
  ...
  ngOnInit(): void {
    this.breadCrumbItems = [{ label: 'Test Management' }, { label: 'Test Types', active: true }];
    this.paginationSettings.getRecords = () => this.getRecords();
    this.getRecords();
  }
  getRecords() {
    this.showLoader();
    this._testTypesService.getAll(
      this.filterText,
      this.typeNameFilter,
      ...
      this.hideLoader();
      if (res.success) {
        this.testTypeList = res.result.items;
        this.myData = [];
  ...
  onDelete(id) {
    ...
    swalWithBootstrapButtons
      ...
      .then(result => {
        if (result.value) {
          this.showLoader();
          this._testTypesService.delete(id)
            .then(res => {
              this.hideLoader();
              if (res.success) {
                this.getRecords();
