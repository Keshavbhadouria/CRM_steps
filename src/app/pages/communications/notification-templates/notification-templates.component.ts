...
export class NotificationTemplatesComponent implements OnInit {
  ...
  filterText: string = '';
  subjectFilter = '';
  notificationEventEventNameFilter = '';
  ...
  tableSettings: ColumnSetting[] = [
    ...
    {
      primaryKey: 'notificationEventEventName',
      header: 'NotificationEvent',
    },
    {
      primaryKey: 'notificationTemplate.subject',
      header: 'Subject',
    }
  ];
  ...
  buttonSettings: ButtonSettings[] = [
    ...
    },
    {
      ...
      func: (obj) => {
        this.showLoader();
        this._notificationTemplateService.getNotificationTemplateForEdit(obj.notificationTemplate.id).then(s => {
          this.hideLoader();
          this.editTemplate = s.result.notificationTemplate;
    ...
    },
    {
      title: 'Delete',
      func: (obj) => {
        this.onDelete(obj.notificationTemplate.id);
      },
  ...
  constructor(private _messageService: MessageService,
    ...
    private _notificationTemplateService: NotificationTemplatesService,
    private translate: TranslateService) { }

  ngOnInit(): void {
    this.breadCrumbItems = [{ label: 'Communications' }, { label: 'Templates', active: true }];
    this.paginationSettings.getRecords = () => this.getRecords();
    this.getRecords();
  }
  getRecords() {
    this.showLoader();
    this._notificationTemplateService.getAll(
      this.filterText,
      this.subjectFilter,
      this.notificationEventEventNameFilter,
      null,
  ...
  onDelete(id) {
    ...
    swalWithBootstrapButtons
      ...
      .then(result => {
        if (result.value) {
          this.showLoader();
          this._notificationTemplateService.delete(id)
            .then(res => {
              this.hideLoader();
              if (res.success) {
                this.getRecords();
