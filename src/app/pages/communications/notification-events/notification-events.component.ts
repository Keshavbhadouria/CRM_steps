...
import { CorporateEventsService } from 'src/app/core/services/corporate-events.service';
...
@Component({
  ...
  //styleUrls: ['./notification-events.component.scss']
})
export class NotificationEventsComponent implements OnInit {
  ...
  tableSettings: ColumnSetting[] = [
    ...
    {
      primaryKey: 'notificationEvent.eventName',
      header: 'EventName',
    },
    {
      primaryKey: 'notificationEvent.isActive',
      header: 'IsActive',
    }
  ];
  ...
  buttonSettings: ButtonSettings[] = [
    ...
    },
    {
      ...
      func: (obj) => {
        this.showLoader();
        this._corporateEventService.getNotificationEventForEdit(obj.notificationEvent.id).then(s => {
          this.hideLoader();
          this.editEvent = s.result.notificationEvent;
    ...
    },
    {
      title: 'Delete',
      func: (obj) => {
        this.onDelete(obj.notificationEvent.id);
      },
  ...
  constructor(private _messageService: MessageService,
    ...
    private _corporateEventService: CorporateEventsService,
    private translate: TranslateService) { }

  ngOnInit(): void {
    this.breadCrumbItems = [{ label: 'Communications' }, { label: 'Events', active: true }];
    this.paginationSettings.getRecords = () => this.getRecords();
    this.getRecords();
  }
  getRecords() {
    this.showLoader();
    this._corporateEventService.getAll(
      this.filterText,
      ...
      this.hideLoader();
      if (res.success) {
        this.eventList = res.result.items;
        this.myData = [];
  ...
  onDelete(id) {
    ...
    swalWithBootstrapButtons
      ...
      .then(result => {
        if (result.value) {
          this.showLoader();
          this._corporateEventService.delete(id)
            .then(res => {
              this.hideLoader();
              if (res.success) {
                this.getRecords();
