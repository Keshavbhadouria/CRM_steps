...
import { CreateOrEditResourceMaterialDto } from '../models/LearningCenter/ResourceMaterial';
...
export class ResourceMaterialService {
  ...
  getAll(filter: string | null | undefined, fileNameFilter: string | null | undefined, uRLFilter: string | null | undefined, courseChapterNewTitleFilter: string | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined) {
    let url_ = environment.apiURL + "/api/services/app/ResourceMaterials/GetAll?";
  ...
  getAllCourseChapterNewForTableDropdown() {
    let url_ = environment.apiURL + "/api/services/app/ResourceMaterials/GetAllCourseChapterNewForTableDropdown";
    url_ = url_.replace(/[?&]$/, "");
  ...
  createOrEdit(body: CreateOrEditResourceMaterialDto | undefined): Observable<void> {
    let url_ = environment.apiURL + "/api/services/app/ResourceMaterials/CreateOrEdit";
    url_ = url_.replace(/[?&]$/, "");
  ...
  delete(id: number | undefined): any {
    let url_ = environment.apiURL + "/api/services/app/ResourceMaterials/Delete?";
    if (id === null)
