...
export class LearningCenterChapterService {
  ...
  getAll(filter: string | null | undefined, chapterNameFilter: string | null | undefined, courseCourseNameFilter: string | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): any {
    let url_ = environment.apiURL + "/api/services/app/CourseChapterNew/GetAll?";
  ...
  createOrEdit(body: CreateOrEditCourseChapterDto | undefined): any {
    let url_ = environment.apiURL + "/api/services/app/CourseChapterNew/CreateOrEdit";
    url_ = url_.replace(/[?&]$/, "");
  ...
  getCourseChapterForEdit(id: number | undefined): any {
    let url_ = environment.apiURL + "/api/services/app/CourseChapterNew/GetCourseChapterForEdit?";
    if (id === null)
  ...
  delete(id: number | undefined): any {
    let url_ = environment.apiURL + "/api/services/app/CourseChapterNew/Delete?";
    if (id === null)
      throw new Error("The parameter 'id' cannot be null.");
    else if (id !== undefined)
      url_ += "Id=" + encodeURIComponent("" + id) + "&";
