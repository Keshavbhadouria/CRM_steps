...
export class CourseChapterAssignmentService {
  ...
  getAll(filter: string | null | undefined, fileNameFilter: string | null | undefined, uRLFilter: string | null | undefined, courseChapterNewTitleFilter: string | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined) {
    let url_ = environment.apiURL + "/api/services/app/Assignments/GetAll?";
  ...
  getAllCourseChapterNewForTableDropdown() {
    let url_ = environment.apiURL + "/api/services/app/Assignments/GetAllCourseChapterNewForTableDropdown";
    url_ = url_.replace(/[?&]$/, "");
  ...
  createOrEdit(body: CreateOrEditAssignmentDto | undefined): Observable<void> {
    let url_ = environment.apiURL + "/api/services/app/Assignments/CreateOrEdit";
    url_ = url_.replace(/[?&]$/, "");
  ...
  delete(id: number | undefined): any {
    let url_ = environment.apiURL + "/api/services/app/Assignments/Delete?";
    if (id === null)
...
export class CreateOrEditAssignmentDto {
  title!: string;
  instructions: string | '';
  points!: number | undefined;
  attempts!: number | undefined;
  dayNo!: number | undefined;
  assignmentTypeId!: number | undefined;
